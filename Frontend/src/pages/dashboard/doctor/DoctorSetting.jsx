...
const records = [
  {
    id: 'MR-3021',
    patientId: 'P-2041',
    patient: 'Anita Shrestha',
    date: 'Today',
    type: 'Consultation',
    diagnosis: 'Essential hypertension - BP uncontrolled',
  ...
  },
  {
    ...
    date: '2 weeks ago',
    type: 'Follow-up',
    diagnosis: 'BP improved (132/84), continue meds',
    doctor: 'Dr. Ram Sharma',
    prescriptions: 2,
    reports: 0,
    status: 'Closed',
  },
  {
    id: 'MR-3019',
    patientId: 'P-2044',
    patient: 'Suresh Magar',
    date: 'Today',
    type: 'Report review',
    diagnosis: 'ECG: NSR, no ischemic changes',
    doctor: 'Dr. Ram Sharma',
    prescriptions: 0,
    reports: 3,
    status: 'Closed',
  },
  {
    id: 'MR-3018',
    patientId: 'P-2048',
    patient: 'Kamal Bhandari',
    date: '5 days ago',
    type: 'Procedure note',
    diagnosis: 'Coronary angiography - LAD 80% lesion, stent placed',
    doctor: 'Dr. Ram Sharma',
    prescriptions: 5,
    reports: 4,
    status: 'Closed',
  },
  {
    ...
    date: 'Yesterday',
    type: 'Consultation',
    diagnosis: 'MVP with mild MR, reassurance',
    doctor: 'Dr. Ram Sharma',
    prescriptions: 1,
    reports: 1,
    status: 'Closed',
  },
  {
    id: 'MR-3016',
    patientId: 'P-2047',
    patient: 'Sarita Gurung',
    date: '1 week ago',
    type: 'Follow-up',
    diagnosis: 'Peripartum CMP resolved, EF 58%',
    doctor: 'Dr. Ram Sharma',
    prescriptions: 0,
    reports: 2,
    status: 'Closed',
  },
  {
    ...
    diagnosis: 'Switched Lisinopril → Telmisartan due to cough',
    doctor: 'Dr. Ram Sharma',
    prescriptions: 2,
    reports: 0,
    status: 'Closed',
...
const recordTypes = [
  ...
  },
  {
    ...
    value: 'Consultation',
    Icon: Stethoscope,
    tone: 'bg-primary-50 text-primary-700 dark:bg-primary-900/30 dark:text-primary-300',
  },
  {
    label: 'Prescriptions',
    value: 'Rx',
...
const DoctorRecords = () => {
  ...
  const filtered = records.filter((r) => {
    if (
      ...
      !(typeFilter === 'Report' && r.reports > 0) &&
      !(typeFilter === 'Rx' && r.prescriptions > 0)
    ) {
      return false;
    }
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            className="flex items-center gap-1.5 rounded-xl bg-primary-600 px-3 py-2 text-xs font-semibold text-white shadow-sm hover:bg-primary-700"
          >
      ...
      <div className="grid gap-6 lg:grid-cols-3">
        ...
        <SectionCard
          ...
          subtitle="Click to view full record"
          bodyClassName="p-0"
        >
          {filtered.length === 0 ? (
            ...
            <ul className="divide-y divide-slate-50 dark:divide-slate-800/70">
              {filtered.map((r) => (
                <li
                  ...
                  className={`cursor-pointer p-4 transition-colors hover:bg-slate-50 dark:hover:bg-slate-800/40 ${
                    selected?.id === r.id
                  ...
                  <div className="flex items-start gap-4">
                    <span
                      className={`flex h-10 w-10 shrink-0 items-center justify-center rounded-xl ${
                        r.type.includes('Consult')
                          ? 'bg-primary-50 text-primary-700 dark:bg-primary-900/30 dark:text-primary-300'
                          : r.type.includes('Procedure')
                            ? 'bg-rose-50 text-rose-700 dark:bg-rose-900/30 dark:text-rose-300'
                            : r.type.includes('Report')
                    ...
                    >
                      ...
                      ) : r.type.includes('Follow') ||
                        r.type.includes('Medication') ? (
        ...
        <SectionCard
          title={selected ? selected.id : 'Record details'}
          subtitle={
            selected
              ? `${selected.patient} · ${selected.date}`
              : 'Select a record'
          }
          bodyClassName="p-0"
        >
            ...
            <div className="divide-y divide-slate-50 dark:divide-slate-800/70">
              <div className="p-5">
                ...
                <div className="mt-4 rounded-xl bg-slate-50 p-4 dark:bg-slate-800/60">
                  ...
                  <p className="mt-2 text-sm leading-snug text-slate-800 dark:text-slate-200">
                    {selected.diagnosis}
                  </p>
                </div>
              </div>
              ...
              <div className="p-5">
                <div className="flex items-center justify-between">
                  <p className="flex items-center gap-1.5 text-xs font-bold uppercase tracking-wide text-slate-500">
                    ...
                    Prescriptions ({samplePrescriptions.length})
                  </p>

                  <Link
                    to="#"
                    className="flex items-center gap-1 text-[11px] font-bold text-primary-700 hover:underline dark:text-primary-300"
                  >
                    Print
              ...
              <div className="p-5">
                <p className="flex items-center gap-1.5 text-xs font-bold uppercase tracking-wide text-slate-500">
                  ...
                  Reports & investigations ({sampleReports.length})
                </p>
              ...
              {/* Action footer */}
              <div className="flex flex-wrap items-center gap-2 bg-slate-50/50 p-4 dark:bg-slate-900/50">
                ...
                <Link
                  to="/doctor/patients"
                  className="ml-auto flex items-center gap-1 text-xs font-bold text-primary-700 hover:underline dark:text-primary-300"
                >
                  Full patient chart
          ...
          <div className="max-h-[90vh] w-full max-w-xl overflow-y-auto rounded-2xl border border-slate-200 bg-white p-6 shadow-2xl dark:border-slate-800 dark:bg-slate-900">
            <div className="flex items-center justify-between border-b border-slate-100 pb-4 dark:border-slate-800">
              <div>
                ...
                <p className="text-xs text-slate-500">
                  Add a new consultation note or encounter.
                </p>
              </div>
            ...
            <div className="mt-4 space-y-3 text-sm">
              ...
              <div>
                ...
                <textarea
                  rows={2}
                  placeholder="e.g. Chest pain on exertion x 3 days"
                  className="w-full rounded-xl border border-slate-200 bg-white px-3 py-2 outline-none focus:border-primary-500 dark:border-slate-800 dark:bg-slate-950 dark:text-white"
                />
              </div>
              ...
              <div>
                ...
                <textarea
                  rows={2}
                  placeholder="Working diagnosis, assessment & plan"
                  className="w-full rounded-xl border border-slate-200 bg-white px-3 py-2 outline-none focus:border-primary-500 dark:border-slate-800 dark:bg-slate-950 dark:text-white"
                />
              </div>
              ...
              <div>
                ...
                <textarea
                  rows={3}
                  placeholder="BP, HR, exam findings, discussion points…"
                  className="w-full rounded-xl border border-slate-200 bg-white px-3 py-2 outline-none focus:border-primary-500 dark:border-slate-800 dark:bg-slate-950 dark:text-white"
                />
              </div>
            </div>
            ...
            <div className="mt-5 flex items-center justify-end gap-2 border-t border-slate-100 pt-4 dark:border-slate-800">
              ...
              <button
                onClick={() => setCreateOpen(false)}
                className="flex items-center gap-1.5 rounded-xl bg-primary-600 px-4 py-2 text-xs font-semibold text-white hover:bg-primary-700"
              >
